...
public class AuthorControllerIntegrationTest {
    ...
    public void testThatListAuthorsReturnsListOfAuthors() throws Exception {
        ...
        mockMvc.perform(
                ...
                MockMvcResultMatchers.jsonPath("$.content[1].name").value(authorEntityB.getName())
        ).andExpect(
                MockMvcResultMatchers.jsonPath("$.content[1].age").value(authorEntityB.getAge())
        ).andExpect(
                MockMvcResultMatchers.jsonPath("$.content[2].id").isNumber()
        ).andExpect(
                MockMvcResultMatchers.jsonPath("$.content[2].name").value(authorEntityC.getName())
        ).andExpect(
                MockMvcResultMatchers.jsonPath("$.content[2].age").value(authorEntityC.getAge())
        );
    }
